...
Опционально: [Graphviz](https://graphviz.org/download/) для генерации схем
(без него документы собираются, но без рисунков).
...
- схемы алгоритмов по нотации ГОСТ 19.701 (Graphviz).
...
gostdoc/
  cli.py           # точка входа
  parser/          # разбор C++/Qt (классы, методы, вызовы)
...
pip install dist/gostdoc-0.1.0-py3-none-any.whl
```
